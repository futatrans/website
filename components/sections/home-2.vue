                    ...
                    <div class="row gy-5 gx-60">
                        <div class="col-xl-6">
                            <div class="about-thumb">
                                ...
                                <div class="thumbShape1 d-none d-xxl-block cir36"><img
                                        src="/vendors/images/shape/aboutThumbShape1_1.png" alt="shape"></div>
                                <div class="thumbShape2 d-none d-xxl-block cir36"><img
                                        src="/vendors/images/shape/aboutThumbShape1_2.png" alt="shape"></div>
                                <div class="thumbShape3 d-none d-xxl-block cir36 float-bob-y"><img
                                        src="/vendors/images/shape/aboutThumbShape1_3.png" alt="shape"></div>
                        ...
                        <div class="col-xl-6">
                            <div class="about-content">
                                ...
                                <ul class="checklist style1 wow fadeInUp max-w-[500px]" data-wow-delay=".2s">
                                    <li class="flex justify-start items-center"><img src="/vendors/images/icon/checkmarkIcon.svg" alt="icon"> Vous payez votre trajet en un clic, via QR Code ou identifiant conducteur</li>
                                    <li class="flex justify-start items-center"><img src="/vendors/images/icon/checkmarkIcon.svg" alt="icon"> Vous suivez vos dépenses transport dans un historique clair et simple</li>
                                    <li class="flex justify-start items-center"><img src="/vendors/images/icon/checkmarkIcon.svg" alt="icon"> Vous rechargez votre portefeuille mobile via Mobile Money ou carte bancaire</li>
