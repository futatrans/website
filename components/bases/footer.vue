<template>
  <div>
    <footer class="footer-section position-relative bg-[#0A3A3C]">
      <div class="footer-widgets-wrapper style1 fix">
        <div class="shape1">
          <img src="/vendors/images/shape/footerShape1_1.png" alt="shape" />
        </div>
        <div class="shape2">
          <img src="/vendors/images/shape/footerShape1_2.png" alt="shape" />
        </div>
        <div class="shape3">
          <img src="/vendors/images/shape/footerShape1_3.png" alt="shape" />
        </div>
        <div class="container">
          <div class="row">
            <div
            ...
            >
              <div class="single-footer-widget">
                ...
                <div class="footer-content">
                  <p>
                    FUTA TRANS révolutionne le transport en Afrique avec une solution de paiement mobile sécurisée pour les conducteurs et les passagers. Transport payé en un clic, en toute sécurité.
                  </p>
            ...
            <div
              class="col-xl-2 col-lg-4 col-md-6 wow fadeInUp"
              data-wow-delay=".8s"
              style="
                visibility: visible;
            ...
            >
              <div class="single-footer-widget">
                <div class="widget-head">
                  <h3 style="text-transform: none !important;">Liens utiles</h3>
                </div>
                <ul class="list-area">
                  <li>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6">
              <div class="single-footer-widget">
                <div class="contact-box">
                  ...
                  <div class="widget-head" style="text-transform: none !important;">Prêt à commencer ?</div>
                  <div class="text">
                    Rejoignez la révolution du transport en Afrique avec FUTA TRANS. Transport sécurisé, paiement simplifié.
                  </div>
                  <div class="info">
                    <div class="icon">
                      <svg
                    ...
                    <div class="link">
                      <a href="mailto:hello@futatrans.com">hello@futatrans.com</a>
                    </div>
                  </div>
                  <div class="info">
                    <div class="icon">
